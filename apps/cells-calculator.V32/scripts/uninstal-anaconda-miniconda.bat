...
IF EXIST "%USERPROFILE%\Miniconda3\Uninstall-miniconda3.exe" "%USERPROFILE%\Miniconda3\Uninstall-miniconda3.exe" /s
if exist "C:\ProgramData\miniconda3\Uninstall-miniconda3.exe" "C:\ProgramData\miniconda3\Uninstall-miniconda3.exe" /s
