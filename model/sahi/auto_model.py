...
# from model.sahi.utils.file import import_model_class
from model.sahi.models.yolov8 import Yolov8DetectionModel
...
class AutoDetectionModel:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # DetectionModel = Yolov8DetectionModel(model_path)
